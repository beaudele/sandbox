...
public class SandBoxRestController {
	...
	public ResponseEntity<Void> createUser(@RequestBody RegisteredUser user, UriComponentsBuilder ucBuilder) {
	...
	public ResponseEntity<RegisteredUser> updateUser(@PathVariable("id") long id, @RequestBody RegisteredUser user) {
